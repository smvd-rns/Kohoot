      ...
      <div className="min-h-full flex flex-col items-center justify-start py-12 px-4 relative z-10">
        {sessionMode === 'self_paced' ? (
          <motion.div 
            ...
            className="text-center max-w-md w-full px-6 py-10 rounded-3xl glass-strong border border-white/10 shadow-2xl mb-8"
          >
            <div className="text-6xl mb-6">🙌</div>
            <h1 className="text-3xl font-black text-white mb-4">Thank You, Participant!</h1>
