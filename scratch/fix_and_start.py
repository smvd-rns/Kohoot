...
try:
    ...
    fix_commands = [
        "mv /root/root/supabase-project /root/supabase-project",
        "rm -rf /root/root"
    ]
    
    if run_commands(ssh, fix_commands):
        print("\nDirectory moved to /root/supabase-project. Modifying .env URLs...")
        
        # We will use Python on the VPS to update the URLs in the .env file at the correct path
